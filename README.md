...
- Blue Team:
    ...
    - with prereqs 1&2 - complex challange->response knocker daemon
        - IE: 
...
Though, I would love for it to be a 1-stop-shop for any team (Red, Blue, the general network operator, etc), the **Big TODO:** has simply gotten to big, and getting to this point has taken long enough(collectively a few hundred hours) that I don't see that happening (this year.)
